...
const favoriteLogoRoute = require("./favoriteLogoRoute");
const favoriteOverlayRoute = require("./favoriteOverlayRoute");
const favoriteUploadRoute = require("./favoriteUploadRoute");
const sharedUploadRoute = require("./sharedUploadRoute");
...
router.use("/shared-scheme", sharedSchemeRoute);
router.use("/favorite-scheme", favoriteSchemeRoute);
